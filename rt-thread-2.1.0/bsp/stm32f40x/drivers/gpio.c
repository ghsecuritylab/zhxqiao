...
{
    { 0, RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_15},	// 	 用于SPI1_CS ,片选W25Q128flash
    { 1, RCC_AHB1Periph_GPIOC, GPIOC, GPIO_Pin_7},	//	OD 用于控制TFT显示屏背光
    { 2, RCC_AHB1Periph_GPIOC, GPIOC, GPIO_Pin_4},	//	OD 恒流源板子的总电源
    { 3, RCC_AHB1Periph_GPIOB, GPIOB, GPIO_Pin_12},	//	 用于SPI2_CS,片选LCD触摸屏
    { 4, RCC_AHB1Periph_GPIOC, GPIOC, GPIO_Pin_6},	//	 T_PEN
    { 5, RCC_AHB1Periph_GPIOC, GPIOC, GPIO_Pin_5},	//	OD PCB_TB6600_POWER
    { 6, RCC_AHB1Periph_GPIOB, GPIOB, GPIO_Pin_0},	//	pp PCB-BOOT0
    { 7, RCC_AHB1Periph_GPIOB, GPIOB, GPIO_Pin_1},	//	pp PCB-RESET

    { 8, RCC_AHB1Periph_GPIOB, GPIOB, GPIO_Pin_8},	//	in TB6600_EN- 下载boot
    { 9, RCC_AHB1Periph_GPIOB, GPIOB, GPIO_Pin_9},	//	in TB6600_DIR-升级APP
    {10, RCC_AHB1Periph_GPIOE, GPIOE, GPIO_Pin_0},	//	in TB6600_PUL-
    {11, RCC_AHB1Periph_GPIOE, GPIOE, GPIO_Pin_1},	//	OD PCB_LEDS_POWER负载的电源
...
int stm32_hw_pin_init(void)
{
	...
	rt_pin_mode(PCB_LEDS_POWER,		PIN_MODE_OUTPUT_OD);//
	rt_pin_mode(PCB_POWER,			PIN_MODE_OUTPUT_OD);
	rt_pin_mode(PCB_BOOT0,			PIN_MODE_OUTPUT_PP);
	rt_pin_mode(PCB_RESET,			PIN_MODE_OUTPUT_PP);
	rt_pin_mode(KEY_DOWNLOAD_BEGIN,	PIN_MODE_INPUT_PULLUP);
	rt_pin_mode(KEY_UPGRADE_BEGIN,	PIN_MODE_INPUT_PULLUP);
	rt_pin_write(PCB_BOOT0,0);
	rt_pin_write(PCB_RESET,1);
	
	rt_pin_write(PCB_LEDS_POWER,1);
	rt_pin_write(PCB_POWER,0);
